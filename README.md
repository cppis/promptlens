...
PromptLens는 아래 방법 중 하나만 감지하면 **자동으로 호출**됩니다.

### Trigger Rules — PromptLens 자동 호출 조건
...
PromptLens 기능별 토큰 소비량 비교입니다. **모델 선택이 가장 큰 변수**입니다.
...
Claude Desktop 대화창에서 `/`를 입력하면 PromptLens 워크플로우 프리셋을 선택할 수 있습니다:
